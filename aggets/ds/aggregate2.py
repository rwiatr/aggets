...
class WindowGenerator:
    def __init__(self, train_df, val_df, test_df,
                 input_width, label_width, shift, label_columns,
                 chunk_size, df=None, samples=32, sample_frac=1.0,
                 label_stride=5, shuffle_reg=False, bin_count=1,
    ...
    def make_dataset(self, agg, lrs, is_train=False):
        ...
        def ts_dataset(features, stride, sequence_length, shuffle, batch_size, with_reverse, shuffle_input,
                       shuffle_output):
            ts_data = []
